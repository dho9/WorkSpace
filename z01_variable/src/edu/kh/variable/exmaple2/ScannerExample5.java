package edu.kh.variable.exmaple2;
...
public class ScannerExample5 {
	...
	public static void main(String[] args) {
		...
		// nextInt() :      100(엔터)     ->    100  (엔터가 후처리x 상태로 남아있음)
		...
		//Scanner.close(); // Cannot make a static reference to the non-static method close() from the type Scanner
