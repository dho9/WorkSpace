package edu.kh.oarr.mode.service; // 2023-03-07 1번



import java.util.Scanner;
import edu.kh.oarr.mode.vo.Member;
...
public class MemberService {
	...
	public void displayMenu() { // 메뉴 화면 출력 기능
		...
		do { // 한 번은 무조건 반복 
			...
			case 4 :
				 ...
				 * switch(result) {
				 * 
				 * case -1 : System.out.println("로그인 해 주세요."); break; case 0 :
				 * System.out.println("비밀번호가 다릅니다. 수정 실패");break; case 1 :
				 * System.out.println("회원 정보 수정 완료"); break; }
				 */
			...
			case 5 : searchRegion();  break; // 이미 메소드 내게 프린트 구문이 작성되어있음
	...
	// 회원가입 메소드
	public String signUp() {  // 하나의 메소드에는 하나의 기능만 작성이 좋음!
