package edu.kh.exception.model.service; // 2023-03-14 2-1
...
public class ExceptionService {
	...
	public int inputNumber() {
		...
		while(true) { // 제대로 실행될 때까지 반복해주기 
			...
			try {
				...
				sc.nextLine(); // 버퍼에 남아 있는 잘못 입력된 문자열을 제거 
	...
	public void ex4() {
		...
		try {
			...
			System.out.println(e.getClass()); // 어떤 예외 클래스인가? 를 알려줌
	...
	public void methodC() throws IOException {
		...
		// 단, UnCheckedExcpetion은 선택적으로 예외처리할 수 있음
	...
	public void methodD() { // 2023-03-15 1
