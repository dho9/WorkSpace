package edu.kh.oop.cls.model.service;  // 2023-03-02 다섯번째
...
public class ClsService /*extends Student*/ {
		...
		public void ex1( ) {
			...
			// (default) class인 TestVO는 import가 불가 (다른 패키지)
...
//			System.out.println(std.v2); 오류났음 
//			System.out.println(std.v3);
//			System.out.println(std.v4);
			
			// 상속 관계에서 직접 접근 가능
//			System.out.println(v1);
//			System.out.println(v2); // protected는 직접 접근 가능(위 클래스 수정됨)
//			System.out.println(v3);
//			System.out.println(v4);
			
		}
		
		public void ex2() {  // 2023-03-02 여덟번째 
			...
			System.out.println("변경 후 std1 : " + Student.schoolName);
			System.out.println("std2 : " + Student.schoolName); //KH고등학교(X) -> KH정보교육원
		...
		public void ex3() { // 2023-03-03 2번, 3번
			// 생성자 확인 테스트
			...
			User u3 = new User("test4","pass444"); // 매개변수 생성자
							// 생성자 수행 시 전달할 값을 작성(순서 꼭 지켜야됨!)
			
							// 생성된 User 객체의 필드에 "test4", "pass444" 초기화됨
		...
		public void ex4() { // 매개변수 생성자 예제 
			...
			User u3 = new User("user03","pass03","서강준",30,'남'); // 매개변수 5개 생성자
			User u4 = new User("user04","pass04","장원영",22,'여'); // 매개변수 5개 생성자
			User u5 = new User("user05","pass05","데프콘",33,'남'); // 매개변수 5개 생성자
