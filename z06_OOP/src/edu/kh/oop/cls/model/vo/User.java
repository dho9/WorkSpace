package edu.kh.oop.cls.model.vo;  // 2023-03-03 3번째
...
public class User {
	...
	public User(String userId,String userPw, String userName, int userAge, char userGender) {
		...
		// (가독성이 조금 어려운 경우가 생길 수 있어서 많이 사용되지 않음)
	...
	// 자바는 기본적으로 필드명, 생성자명, 메소드명, 변수명의 중복을 허용하지 않음 (2023-03-03 4번째)
	/*
	private String userID; //The value of the field User.userID is not used
