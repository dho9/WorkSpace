package edu.kh.poly.ex1.model.service; // 2023-03-09 2-4
...
public class PolyService {
	...
	public void ex1() {
		...
		Car car2 = new Tesla(); // -> (자료형이 다름에도) 오류 발생 안함
		// Tesla 객체를 참조하는 변수의 타입이 Car(부모)이기 때문에
		// Tesla 객채가 Car(부모) 객체로 변화함 
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		//car2.setBatterCapacity(1000000); // 오류발생(부모 객체로 변하면서 자식객체는 안보임!) 
		...
		car3.setFuel("휘발유");
		car3.setWheel(4);
		// car3.setDiscountOffer(0.5); // 오류발생
	...
	public void ex2() { 
		...
		// Car[] arr = {new Car(), new Tesla(), new Spark()}; 
  		...
  		// -> 참조하는 객체가 특정 자료형 이거나 부모쪽 상속 관계인지를 확인(주의필요)
