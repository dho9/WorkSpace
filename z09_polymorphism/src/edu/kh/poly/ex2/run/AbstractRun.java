package edu.kh.poly.ex2.run; // 2023-03-10 2-3
...
import edu.kh.poly.ex2.model.service.YSYCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		// import edu.kh.poly.ex2.model.service.JHSCalculator;
		//Calculator cal = new YSYCalculator();
		...
		// 코드의 큰 수정 없이 
		// 객체 생성 코드만 바꾸면 새로운 코드를 수행할 수 있다.
