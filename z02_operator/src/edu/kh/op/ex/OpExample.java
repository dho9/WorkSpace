...
public class OpExample { // 예제 코드 작성용 클래스 
	...
	public void ex3() {
		...
		System.out.println("temp2 : " + temp2); // 값 2
		
		int a = 3; 
		int b = 5;
		int c = a++ + --b; // 연사자 총 4개(대입연산자까지)
	...
	public void ex5( ) {
		...
		// a는 100 이상 이면서 짝수인가?
		System.out.println((a >= 100) && (a % 2==0) ); //괄호 쓰지 않아도 연산자 우선순위에 따라 부등호->논리연산 순으로 진행, 결과값 동일
		...
		System.out.println( (b>=1) && (b<=10) ); // 두 가지 조건 만족하는가?
	...
	public void ex7() {
		...
		a -=10;
		System.out.println("a를 10감소 : " + a );// a를 10 감소
		
		a *= 3; 
		System.out.println("a를 3배증가 : " + a );// a를 3배 증가
		
		a /= 6;
		System.out.println("a를 6으로 나눴을 때 몫 : " + a );// a를 6으로 나눴을 때 몫
		
		a %= 2;
		System.out.println("a를 2로 나눴을때 나머지 : " + a );// a를 2로 나눴을 때 나머지 
